...
<div class="card card-info">
    <div class="card-header">
        <h3 class="card-title">Inscribir a Materias de un Nuevo Módulo</h3>
    </div>
    <div class="card-body">
...
<div class="card card-success">
    <div class="card-header">
        <h3 class="card-title">Seleccionar Materias para Inscribir del <strong>{{ $materiasParaInscribir->first()->modulo->nombre }}</strong></h3>
    </div>
    <div class="card-body">
            ...
            <tbody>
                ...
                <tr>
                    <form action="{{ route('alumnos.materia.update', ['alumno' => $alumno, 'materia' => $materia]) }}" method="POST">
                        ...
                        <td><input type="number" name="nota_final" class="form-control form-control-sm" value="{{ $data->pivot->nota_final }}" step="0.01" min="0" max="10"></td>
                        <td>
                        ...
                        <td class="d-flex">
                            <button type="submit" class="btn btn-sm btn-success mr-1" title="Guardar"><i class="fas fa-save"></i></button>
                    </form>
